...
from src.models import User, Post, user_post
...
target_metadata = [User.metadata, Post.metadata, user_post.metadata]
...
def render_item(type_, obj, autogen_context):
    ...
    if type_ == "type" and obj.__class__.__module__.startswith(
            "sqlalchemy_utils."):
